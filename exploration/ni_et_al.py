...
In addition to the above, the following extracted sections of the annual report have been made available to you for review:
...
apikey_file = os.path.join(project_dir, 'apikey.ini')
config = configparser.ConfigParser()
config.read(apikey_file)
